...
class Captcha
{
    ...
    public function entry($id = '')
    {
        ...
        // 验证码字体随机颜色
        // $this->_color = imagecolorallocate($this->_image, 63, 137, 236);
        ...
        if ($this->useZh) {
            ...
            for ($i = 0; $i < $this->length; $i++) {
                ...
                $codeNX += mt_rand($this->fontSize * 1.0, $this->fontSize * 1.1);
                imagettftext($this->_image, $this->fontSize, mt_rand(-2, 20), $codeNX, $this->fontSize * 1.1, $this->_color, $this->fontttf, $code[$i]);
            }
        }
